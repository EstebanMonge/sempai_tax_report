...
class SempaiTaxReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        purchase_subtotal = currency.round(
            sum(
